...
#### Scenario: [MANUAL-VERIFICATION-ONLY] Live 6h schedule fires correctly in production — CONFIRMED
...
- **CONFIRMED by user, 2026-08-20**, verbatim (Spanish): "Ya confirmé el ciclo de 6hs, cierra el SDD" (= "I already confirmed the 6h cycle, close the SDD"). (Not automatable — no live n8n execution/scheduling harness exists in this repo; this scenario was closed by explicit user confirmation, per this project's manual-verification-gate norm.)
